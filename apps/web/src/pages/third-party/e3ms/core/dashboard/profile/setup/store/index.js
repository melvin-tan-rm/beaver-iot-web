...
export const updateData = createAsyncThunk(
  ...
  async (payloadData) => {
    const response = await axios.post("http://localhost:5099/api/dashboardprofile", payloadData.data)
    return response
  }
)
...
export const getData = createAsyncThunk(
  ...
  async (params) => {
    const response = await axios.get("http://localhost:5099/api/dashboardprofile", params)
    return {
      params,
      data: response.data,
...
export const fetchSingleDetailedRecord = createAsyncThunk(
  ...
  async (params) => {
    const response = await axios.get(
      `http://localhost:5099/api/dashboardprofile/fetch-detailed/${params}`
    )
    return {
      data: response.data
    }
...
export const getDataByBuildingId = createAsyncThunk(
  ...
  async (params) => {
    const response = await axios.get("http://localhost:5099/api/dashboardprofile/view", params)
