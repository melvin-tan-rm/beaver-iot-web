    ...
    if (dateRange !== undefined && intervals !== undefined) {
      async function fetchData() {
        const response = await axios.get(
          ...
          //`http://localhost:5099/api/point/getcharts?id=${id}&DefaultInterval=${intervals}&FromDate=2024-09-10 00:00:00&ToDate=2024-09-20 23:59:59` //&FromDate=2024-01-01`
        )
        ...
        if (comparisonDateRange !== undefined && comparisonDateRange !== null) {
          const comparisonResponse = await axios.get(
            `http://localhost:5099/api/point/getcharts?id=${id}&DefaultInterval=${intervals}${comparisonDateRange}` //&FromDate=2024-01-01`
          )
